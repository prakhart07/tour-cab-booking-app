    ...
    return (
        <footer className="bg-black text-white py-10 px-6 lg:px-20">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-gray-400 text-sm">
                        ...
                        <li><a onClick={() => {navigate("/tour-packages");}} className="hover:text-white">Tour Packages</a></li>
                        <li><a onClick={() => {navigate("/about");}} className="hover:text-white">About Us</a></li>
                        <li><a onClick={() => {navigate("/contact-us");}} className="hover:text-white">Contact Us</a></li>
                        {/* <li><a onClick={() => {navigate("/driver-app");}} className="hover:text-white">Driver App</a></li>
                        <li><a onClick={() => {navigate("/vendor-app");}} className="hover:text-white">Vendor App</a></li> */}
                    </ul>
                </div>
            ...
            <div className="text-center text-gray-500 text-sm mt-10">
                © Copyright 2026 - Swara Trips Indore.
            </div>
        </footer>
    );
}
